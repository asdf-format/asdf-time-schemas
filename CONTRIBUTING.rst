...
`asdf-time-schemas's github page <https://github.com/asdf-format/asdf-time-schemas>`_.
...
.. note::
    ASDF-time-schemas is mostly a collection of schemas for the ASDF format. This means that
